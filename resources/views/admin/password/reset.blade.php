                    ...
                    <form class="user" action="{{ route('password.update') }}" method="post">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="password" name="password" class="form-control form-control-user @error('password') is-invalid @enderror " id="exampleInputPassword" placeholder="New Password">
                                @error('password')
                        ...
                        <input type="submit" name="btn" value="Update Password" class="btn btn-primary btn-user btn-block"/>
                  </form>
                  <hr>
                  <div class="text-center">
